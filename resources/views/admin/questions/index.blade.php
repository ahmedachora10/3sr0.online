                                                ...
                                                @foreach ($questions as $question)
                                                    <tr>
                                                        ...
                                                        <td style=" max-width: 200px; ">
                                                            <a href="{{$question->youtube_link}}" target="_blank"> {{$question->youtube_link}}</a></td>
                                                        <td>{{$question->font_size}}</td>
                                                        <td>{{$question->algiment}}</td>
                                                        <td>{{$question->color}}
                                                            <br>
                                                            <span style=" display: block; height: 30px; background: {{$question->color}}; border: 2px solid #000; "></span>
                                                        </td>
